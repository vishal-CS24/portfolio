const textContainer = document.getElementById("text-container");
      ...
      const texts = ["PYTHON","MACHINE LEARNING","DATA SCIENCE","TABLEAU","C++", "C", "HTML","CSS","MySQL"];
      let index = 0;
      let textIndex = 0;
      ...
      document.getElementById("collapse-button").addEventListener("click", function() {
        ...
        if (imageContainer.classList.contains("show")) {
          ...
          button.innerHTML = "Show More <i class='fas fa-angle-down' aria-hidden='true'></i>";
        } else {
          imageContainer.classList.remove("hide");
          imageContainer.classList.add("show");
          button.innerHTML = "Show Less <i class='fas fa-angle-up' aria-hidden='true'></i>";
        }
      });
